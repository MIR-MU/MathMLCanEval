...
public class SourceDocumentTest
{
    ...
    @Autowired SourceDocumentService sourceDocumentService;
    ...
    public void testUpdateSourceDocument()
    {
        ...
        result.setPath("/home/root/input/doc.xml");
        ...
        assertEquals("SourceDocument object does not have proper path after update.", "/home/root/input/doc.xml",updatedResult.getPath());
    }
    ...
    public void getDocumentsOnSubPath()
    {
        ...
        {
            assertEquals("SourceDocument in resultList does not have proper path.",true,sd.getPath().startsWith("/home/empt/input/data/"));
        }
    }
    ...
    private void deepCompare(SourceDocument expected, SourceDocument actual)
    {
        ...
        assertEquals("Given SourceDocument does not have expected path.", expected.getPath(),actual.getPath());
