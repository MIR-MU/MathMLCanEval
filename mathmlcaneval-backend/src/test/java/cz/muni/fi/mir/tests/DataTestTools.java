...
public class DataTestTools
{
    ...
    public static List<User> provideUserRoleListGeneral(List<UserRole> roles)
    {
        ...
        result.add(EntityFactory.createUser("username1", "password1", "druhe viac aslovne cislo1", "example@example.com", roles));
        result.add(EntityFactory.createUser("username2", "password2", "druhe viac aslovne cislo2", "example@example.com", roles));
        result.add(EntityFactory.createUser("username3", "password3", "druhe viac aslovne cislo3", "example@example.com", roles));
    
        return result;
    }
    
    /**
     * Method is same as {@link #provideUserRoleListGeneral(java.util.List) } with
     * following difference. Roles are set in this way:
     * <table>
    ...
    public static List<User> provideUserRoleListSpecific(List<UserRole> roles)
    {
        List<User> result = new ArrayList<>();
        result.add(EntityFactory.createUser("username1", "password1", "druhe viac aslovne cislo1", "example@example.com", roles));
        result.add(EntityFactory.createUser("username2", "password2", "tretie aslovne cislo2", "example@example.com", roles.subList(0, 2)));
        result.add(EntityFactory.createUser("username3", "password3", "druhe viac aslovne cislo3", "example@example.com", roles.get(0)));
    ...
    public static List<Configuration> provideConfigurationList()
    {
        ...
        result.add(EntityFactory.createConfiguration(TestTools.getConfig(true, true, true), "vsetko true", "vsetky hodnoty su true lebo kacka"));
        result.add(EntityFactory.createConfiguration(TestTools.getConfig(true, true, false), "priemerny config 2:1", "vsetky hodnoty su true lebo medved"));
        result.add(EntityFactory.createConfiguration(TestTools.getConfig(false, false, false), "vsetko false", "vsetky podnoty su true lebo holub"));
     ...
     * <tr><td>poznamka testovacia cislo 1</td><td>/home/empt/input/test1.xhtml</td></tr>
     * <tr><td>poznamka testovacia cislo 2</td><td>/home/empt/input/data/test2.xhtml</td></tr>
     * <tr><td>poznamka testovacia cislo 3</td><td>/home/empt/input/fata/test3.xhtml</td></tr>
     * <tr><td>poznamka testovacia cislo 4</td><td>/home/empt/input/data/test4.xhtml</td></tr>
     * </table>
     * 
     ...
     * <tr><td>f383d4a196c27992bf9bcb903919cf354024554a</td><td>nahodna poznamka aby sa nieco naslo</td></tr>
     * <tr><td>f383d4a196c27992bf9bcb903919cf354024554b</td><td>nahodna poznamka aby sa nieco naslo</td></tr>
     * <tr><td>f383d4a196c27992bf9bcb903919cf354024554c</td><td>nahodna poznamka aby sa nieco naslo</td></tr>
     * <tr><td>f383d4a196c27992bf9bcb903919cf354024554d</td><td>toto sa nenajde</td></tr>
     * </table>
     ...
     * 
     * <table>
     * <tr><td>name</td><td>linux verzia</td><td>-d -s -p</td><td>version</td></tr>
     * <tr><td>texlive</td><td>linux verzia</td><td>-d -s</td><td>2013.2</td></tr>
     * <tr><td>texlive</td><td>linux verzia</td><td>-d -p</td><td>2013.2</td></tr>
     * <tr><td>texlive</td><td>linux verzia</td><td>-a -q</td><td>2013.3</td></tr>
     * <tr><td>miktex</td><td>windows verzia</td><td>-a -q</td><td>2011.4</td></tr>
     * <tr><td>miktex</td><td>linux verzia</td><td>-a -q</td><td>2014.1beta.0.0.3</td></tr>
     * </table>
     * @return 
     */
