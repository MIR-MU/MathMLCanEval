...
public class FormulaInterceptor
{
    ...
    @Before("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.FormulaService.annotateFormula(..)) && args(formula,annotation)")
    ...
    @Before("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.FormulaService.deleteAnnotationFromFormula(..)) && args(formula,annotation)")
