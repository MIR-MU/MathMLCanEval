...
public class ConfigurationInterceptor
{
    ...
    @After("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.ConfigurationService.createConfiguration(..)) && args(configuration)")
    ...
    @Before("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.ConfigurationService.deleteConfiguration(..)) && args(configuration)")
