...
public class RevisionInterceptor
{
    ...
    @After("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.RevisionService.createRevision(..)) && args(revision)")
    ...
    @Before("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.RevisionService.deleteRevision(..)) && args(revision)")
    ...
    @Before("execution(* cz.muni.fi.mir.mathmlevaluation.db.service.RevisionService.updateRevision(..)) && args(revision)")
