                                                    ...
                                                    <c:otherwise>
                                                        <c:forEach items="${formulaSearchRequestForm.elementRows}" var="entry" varStatus="i">
                                                            <div class="row form-row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <form:select 
                                                                        path="elementRows[${i.index}].element" 
                                                                        cssClass="form-control elementList"
                                                                        >
                                                                        <%-- automatic conversion does not work here... --%>
                                                                        <c:forEach items="${elementList}" var="elementEntryList">  
                                                                            <c:choose>
                                                                                <c:when test="${elementEntryList.id eq formulaSearchRequestForm.elementRows[i.index].element.id}">
                                                                                    <option value="${elementEntryList.id}" selected="selected"><c:out value="${elementEntryList.elementName}" /></option>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    <option value="${elementEntryList.id}"><c:out value="${elementEntryList.elementName}" /></option>
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        </c:forEach>
