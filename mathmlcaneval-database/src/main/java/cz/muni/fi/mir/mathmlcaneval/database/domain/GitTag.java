...
{
    private static final long serialVersionUID = -8889073230526480886L;
    ...
    public GitRevision getGitRevision()
    {
        return gitRevision;
    }

    public void setGitRevision(GitRevision gitRevision)
    {
